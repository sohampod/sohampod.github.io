...
const projects: Project[] = [
  ...
  },
  {
    ...
    links: [
      { name: 'Discord Case Study', url: 'https://www.figma.com/deck/e0fGZ4yg77hcKYDzUdQxxA/Discord-Case-Study?node-id=1-42&viewport=-73%2C-100%2C0.58&t=2IGbubGZaTfajX4M-1&scaling=min-zoom&content-scaling=fixed&page-id=0%3A1', type: 'figma', icon: '🔗' },
      ...
      { name: 'TLDR; Case Study', url: 'https://sohampod.super.site/discord-a-ux-case-study', type: 'documentation', icon: '📚' }
    ]
  },
  {
    id: 'project2',
