...
export const TopBar: React.FC = () => {
  ...
  return (
    <header className="relative bg-[rgba(255,255,255,0.05)] flex w-full items-center gap-[40px_100px] justify-between flex-wrap px-20 py-2 max-md:max-w-full max-md:px-5">
