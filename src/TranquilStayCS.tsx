            ...
            >
                ...
                <motion.div variants={fadeIn} className="w-full max-w-[832px] px-8 mt-12">
                    <ImageWithLightbox
                        ...
                        alt="The Tranquil Stay Moodboard"
                        caption="moodboard: established visual direction for the tranquil stay"
                    />
                    <div className="px-1 text-right mt-1.5">
                        <span className="text-[11px] text-zinc-400">visual moodboard</span>
                    </div>
                </motion.div>
                ...
                {/* Visual 2: Figma Slide Deck Embed */}
                <motion.div variants={fadeIn} className="w-full max-w-[832px] px-8 mt-12">
                    <div className="aspect-video bg-zinc-50 border border-zinc-100 rounded-md overflow-hidden relative">
                        <iframe
                            className="w-full h-full border-none"
                            src="https://www.figma.com/embed?embed_host=share&url=https%3A%2F%2Fwww.figma.com%2Fdeck%2F0lND8fw9VhOpKsVwC5HkIs%2FBrand-Guidelines%3Fnode-id%3D2-456%26t%3DzdTRfekygRh4fHv9-1%26scaling%3Dmin-zoom%26content-scaling%3Dfixed%26page-id%3D0%253A1"
                            allowFullScreen
                        />
                    </div>
                    <div className="px-1 text-right mt-1.5">
                        <span className="text-[11px] text-zinc-400">brand guidelines slide deck</span>
                    </div>
                </motion.div>
                ...
                {/* Visual 4: Functional Touchpoint */}
                <motion.div variants={fadeIn} className="w-full max-w-[832px] px-8 mt-12">
                    <ImagePlaceholder label="functional touchpoint: menu back page with contact info & qr" />
                    <div className="px-1 text-right mt-1.5">
                        <span className="text-[11px] text-zinc-400">final utility & checkout flow</span>
                    </div>
                </motion.div>
